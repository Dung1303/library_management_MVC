...
<div class="borrow-container">
    ...
    <div class="borrow-header">
        ...
        <div class="borrow-actions">
            ...
            <div class="borrow-tabs">
                ...
                <a href="<?= BASE_URL ?>/borrow/history" class="btn active">
                    History
                </a>
            </div>
    ...
    <div class="pagination">
        <!-- Previous -->
        <?php if ($page > 1): ?>
        <a href="<?= BASE_URL ?>/borrow/history?page=<?= $page - 1 ?>" class="btn-page">← Previous</a>
        <?php endif; ?>
        ...
        <?php else: ?>
        <a href="<?= BASE_URL ?>/borrow/history?page=<?= $i ?>" class="btn-page"><?= $i ?></a>
        <?php endif; ?>
        <?php endfor; ?>

        <!-- Next -->
        <?php if ($page < $totalPages): ?>
        <a href="<?= BASE_URL ?>/borrow/history?page=<?= $page + 1 ?>" class="btn-page">Next →</a>
        <?php endif; ?>
    </div>
