...
<div class="container my-5">
    <div class="page-title">
        ...
        <span>Currently Borrowed & Borrow History</span>
    </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm border-0 cursor-pointer section-card section-transition" data-section="current">
                <div class="card-body text-center py-5">
                    ...
                    <h5 class="card-title section-card-title">Currently Borrowed</h5>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm border-0 cursor-pointer section-card section-transition" data-section="history">
                <div class="card-body text-center py-5">
                    ...
                    <h5 class="card-title section-card-title-history">Borrow History</h5>
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info text-center" role="alert">
                    <i class="bi bi-info-circle"></i> You currently have no books borrowed.
                </div>
                <?php else: ?>
    ...
    <div id="history-section" class="section-content" style="display: none;">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info text-center" role="alert">
                    <i class="bi bi-info-circle"></i> You have no borrow history yet.
                </div>
                <?php else: ?>
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
